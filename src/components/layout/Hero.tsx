      ...
      <div className="mx-auto max-w-[1200px] px-4 pb-12 pt-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden md:flex justify-center">
          <div className="relative w-72 rounded-2xl bg-white/10 backdrop-blur-lg border border-white/20 p-6 shadow-2xl">
            <p className="text-xs text-purple-200 mb-1 uppercase tracking-wide">Valor estimado</p>
            ...
            <div className="flex justify-between text-xs text-purple-200">
              <span>$420M</span><span>$485M</span>
            </div>
            <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-teal-400 flex items-center justify-center text-sm font-bold text-white shadow-lg">✓</div>
          </div>
        </div>
      </div>
    </section>
